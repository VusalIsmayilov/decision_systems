...
import CompressionBlock from '@/components/CompressionBlock';
    ...
    <>
      ...
      <section className="flex scroll-mt-[5.5rem] items-start bg-[#0A1628]">
        <div className="mx-auto w-full max-w-[1280px] px-10 pb-24 pt-24 max-md:px-5 max-md:pb-16 max-md:pt-24 max-sm:pt-28 md:pt-28 lg:pb-24 lg:pt-32 xl:pt-[8.5rem]">
          ...
          {/* [EXIT ZONE — bottom-right isolated CTA] */}
          <div className="mt-14 flex w-full justify-end border-t border-[rgba(255,255,255,0.12)] pt-10 max-md:mt-12 md:mt-14 lg:mt-[3.75rem] lg:pt-11 xl:mt-16 xl:pt-12">
            <Link
      ...
      <SectionWrapper bg="gray">
        <div className="mx-auto w-full max-w-[1040px]">
          ...
          {/* [EXIT / TRANSITION — bottom-right directional] */}
          <div className="mt-9 border-t border-[rgba(10,22,40,0.08)] pt-9 lg:mt-10 lg:flex lg:justify-end lg:pt-10">
            <Link
              href={L('/how-we-work')}
              className="inline-block text-right text-[16px] font-medium leading-[1.5] text-[#2B5CE6] transition-colors hover:text-[#1E4AC4] max-sm:text-[15px]"
            >
              See How We Work →
            </Link>
          </div>
      ...
      <SectionWrapper bg="navy" className="!py-24 md:!py-28 lg:!py-28 xl:!py-28 2xl:!py-28">
        <div className="mx-auto w-full max-w-[1040px]">
          ...
          <div className="mt-12 flex flex-col items-end lg:mt-14">
            ...
            {/* Vertical space before the single action trigger */}
